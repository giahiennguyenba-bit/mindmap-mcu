...
export const AuroraBackground = ({
  ...
  return (
    <div
      className={cn(
        "transition-bg relative flex h-full flex-col bg-zinc-50 dark:bg-zinc-900",
        className,
      )}
      {...props}
    >
      <div
        ...
        style={
          {
            "--aurora":
              "repeating-linear-gradient(100deg,#64748b_10%,#94a3b8_15%,#cbd5e1_20%,#e2e8f0_25%,#94a3b8_30%)",
            "--dark-gradient":
      ...
      {/* Children render above the aurora */}
